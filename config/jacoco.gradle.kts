...
tasks.register<JacocoReport>("jacocoTestReport") {
    ...
    classDirectories.setFrom(
        fileTree("${project.rootDir}/app/build/intermediates/javac/stagingDebug/classes") {
            exclude(fileFilter)
        },
        fileTree("${project.rootDir}/common-ktx/build/intermediates/javac/stagingDebug/classes") {
            exclude(fileFilter)
        },
        fileTree("${project.rootDir}/app/build/tmp/kotlin-classes/stagingDebug") {
            exclude(fileFilter)
        },
        fileTree("${project.rootDir}/common-ktx/build/tmp/kotlin-classes/stagingDebug") {
            exclude(fileFilter)
        }
    )
